    ...
    <div class="container mx-auto bg-white shadow-lg rounded-lg p-8 mt-12">
        ...
        <div class="border border-gray-200 rounded-lg mb-6 p-6 bg-gray-50">
            <div class="flex justify-between items-center mb-4">
                <div>
                    <h2 class="text-xl font-semibold text-gray-700">Číslo objednávky: {{$order->order_number}}</h2>
                    <p class="text-gray-500">Dátum objednávky: {{ $order->created_at->format('d.m.Y') }}</p>
                </div>
                <div>
            ...
            <div class="border-t border-gray-200 py-4">
                <h3 class="text-lg font-semibold text-gray-600 mb-3">Položky objednávky:</h3>
                <ul class="space-y-2">
            ...
            <div class="flex justify-between items-center mt-4">
                <span class="text-lg font-semibold text-gray-800">Celková cena:</span>
