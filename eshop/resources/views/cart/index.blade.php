...
<div class="overflow-x-auto flex justify-center">
    <table class="border border-gray-300 divide-y divide-gray-200 m-10">
...
<!-- Celkova suma + tlacidlo -->
<div class="flex justify-center ml-80">
    <form action="{{route('order.index')}}" class="text-right">
        <h4 class="text-lg font-semibold mt-3">Celková cena: {{$totalPrice}}<i class="fa-solid fa-euro-sign fa-xs"></i></h4>
        <button class="bg-gray-800 hover:bg-gray-900 text-white font-bold py-2 px-4 rounded mt-4">Pokračovať</button>
    </form>
</div>
